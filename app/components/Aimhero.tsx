  ...
  return (
    <Animation>
      <div className={`mt-[6rem] w-full ${poppins} mb-[10rem]`}>
        <h1 className={`text-9xl font-extrabold mb-14 max-lg:text-7xl text-center py-24 merriweather text-white`}>
          Our <span className='text-blue-600'>Aim</span>
        </h1>

      <div className='flex max-lg:flex-col justify-evenly items-center text-center'>

        <MotionDiv className='w-[400px] h-[350px] bg-white py-12 px-6 shadow-2xl duration-90' {...leftAnimation}
        ...
        <MotionDiv 
          className='w-[400px] h-[350px] bg-white py-12 px-6 shadow-2xl hover:scale-105 duration-90' 
          {...popAnimation}
          whileHover={{ scale: 1.05 }}>
