  ...
  return (
    <Animation>
      <div className={`mt-[6rem] w-full ${poppins} mb-[10rem]`}>
        <h1 className={`text-8xl font-extrabold mb-10 max-lg:text-7xl text-center p-2 merriweather`}>
          Our <span className='text-cyan-700'>Aim</span>
        </h1>

      <div className='flex max-lg:flex-col justify-evenly items-center text-center'>

        <MotionDiv className='w-[350px] h-auto bg-white mb-2 py-8 pb-12 px-6 shadow-2xl duration-90' {...leftAnimation}
        whileHover={{ scale: 1.05 }}>
          <h2 className='font-bold uppercase text-xl mb-6'>Importance of DSA</h2>
          <p className='text-gray-700 text-base text-balance'>
        ...
        <MotionDiv 
          className='w-[350px] h-auto bg-white mb-2 py-8 pb-12 px-6 shadow-2xl hover:scale-105 duration-90' 
          {...popAnimation}
          whileHover={{ scale: 1.05 }}>
